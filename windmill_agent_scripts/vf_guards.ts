/** Pure Voiceflow boundary guards kept flat for Windmill deployment. */
...
export const isNumericFolderID = (id: string): boolean => VoiceflowRegex.numericID.test(id);
...
const hasPathSeparator = (value: string): boolean => VoiceflowRegex.pathSeparator.test(value);
